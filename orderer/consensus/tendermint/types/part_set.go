...
import (
	...
	"github.com/hyperledger/fabric/orderer/consensus/tendermint/merkle"
	"github.com/hyperledger/fabric/orderer/consensus/tendermint/tmhash"
...
func (psh PartSetHeader) String() string {
	return fmt.Sprintf("%v:%X", psh.Total, psh.Hash[:8])
}
